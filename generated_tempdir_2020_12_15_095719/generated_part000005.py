...
class CommutativeMatcher2337(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher2337._instance is None:
            CommutativeMatcher2337._instance = CommutativeMatcher2337()
        return CommutativeMatcher2337._instance
