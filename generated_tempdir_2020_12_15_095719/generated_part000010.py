...
class CommutativeMatcher2466(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher2466._instance is None:
            CommutativeMatcher2466._instance = CommutativeMatcher2466()
        return CommutativeMatcher2466._instance
