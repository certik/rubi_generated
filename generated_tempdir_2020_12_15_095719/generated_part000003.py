...
class CommutativeMatcher2410(CommutativeMatcher):
    _instance = None
    patterns = {
    0: (0, Multiset({0: 1}), [
    ...
    @staticmethod
    def get():
        if CommutativeMatcher2410._instance is None:
            CommutativeMatcher2410._instance = CommutativeMatcher2410()
        return CommutativeMatcher2410._instance
